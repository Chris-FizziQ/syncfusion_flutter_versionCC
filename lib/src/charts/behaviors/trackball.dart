...
class TrackballBehavior extends ChartBehavior {
  ...
  void _drawLine(
    ...
    if (_isTransposed) {
      ...
      // Ligne verticale
      if (lineType == TrackballLineType.vertical || lineType == TrackballLineType.both) {
        path
          ..moveTo(x, plotAreaBounds.top)
          ..lineTo(x, plotAreaBounds.bottom);
      }

      // Ligne horizontale qui passe par le point de la courbe
      if (lineType == TrackballLineType.horizontal || lineType == TrackballLineType.both) {
        path
          ..moveTo(plotAreaBounds.left, y)
          ..lineTo(plotAreaBounds.right, y);
      }
